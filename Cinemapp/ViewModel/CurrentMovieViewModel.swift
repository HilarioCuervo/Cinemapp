...
//  Cinemapp
//
//  Created by Hilario Cuervo on 21/01/2022.
//
...
class CurrentMovieViewModel {
    
    private var movie = CurrentMovieModel(title: "-", backdropPath: "-", genres: [], releaseDate: "-", overview: "-", posterPath: "-")
